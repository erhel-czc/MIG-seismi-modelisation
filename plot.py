...
data = Result.load_results("Results/PR_QDYN_RNS_modele_oriente/0.5_1.0339460065412583e-08_0.01258479002277847_1.0.pkl") # Load previously saved results in the Results folder
