...
On multiplie par $\frac{v_p b \sigma}{d_c}$ :
...
Comme $\frac{d \bar{v}}{d \bar{t}}=\frac{d_c}{{v_p}^2}$ et en posant $\bar{\eta}=\frac{\eta v_p}{b \sigma}$, on obtient:
...
\frac{ -\kappa(\bar{v} - 1)
  +\bar{v}
  - \frac{1}{\bar{\theta}} }{ \bar{\eta}+\frac{\alpha}{\bar{v}}}
\]
\end{equation}
